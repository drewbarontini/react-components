...
export default class extends React.Component {
  ...
  render() {
    return(
      <div className='share'>
        <a className='share-link' onClick={ this._handleShare.bind( this, 'twitter' ) } href='#'>Twitter</a>
        <a className='share-link' onClick={ this._handleShare.bind( this, 'facebook' ) } href='#'>Facebook</a>
        <a className='share-link' onClick={ this._handleShare.bind( this, 'google' ) } href='#'>Google+</a>
      </div>
    );
  }
